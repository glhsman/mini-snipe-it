...
$category = $masterData->getCategoryById($id);
...
<head>
    ...
    <title>Kategorie bearbeiten - Mini-Snipe</title>
        ...
        <div class="card" style="max-width: 600px;">
            ...
            <form method="POST">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" value="<?php echo htmlspecialchars($category['name']); ?>" required autofocus>
                </div>
                <div class="form-group">
                    <label>Kürzel (2 Großbuchstaben, z.B. NB)</label>
                    <input type="text" name="kuerzel" class="form-control" maxlength="2" pattern="[A-Za-z]{2}" placeholder="z.B. NB" value="<?php echo htmlspecialchars($category['kuerzel'] ?? ''); ?>" style="text-transform: uppercase;">
                </div>
