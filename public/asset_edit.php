...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($data['serial']) || empty($data['status_id'])) {
        ...
        try {
            ...
            if ($e->getCode() == 23000) {
                $error = "Dieses Asset-Tag existiert bereits bei einem anderen Asset.";
            } else {
            ...
            <form method="POST">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="serial" class="form-control" required value="<?php echo isset($_POST['serial']) ? htmlspecialchars($_POST['serial']) : htmlspecialchars($asset['serial'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
                        <label>Asset-Tag</label>
                        <input type="text" name="asset_tag" class="form-control" placeholder="Wird automatisch generiert falls leer" value="<?php echo isset($_POST['asset_tag']) ? htmlspecialchars($_POST['asset_tag']) : htmlspecialchars($asset['asset_tag'] ?? ''); ?>">
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_id" class="form-control" required>
                            ...
                            <?php foreach ($statusLabels as $status): ?>
                                <?php $selectedStatus = isset($_POST['status_id']) ? $_POST['status_id'] : $asset['status_id']; ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="location_id" class="form-control">
                            ...
                            <?php foreach ($locations as $loc): ?>
                                <?php $selectedLocation = isset($_POST['location_id']) ? $_POST['location_id'] : $asset['location_id']; ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="user_id" id="user-select" class="form-control">
                            ...
                            <?php foreach ($users as $user): ?>
                                <?php $selectedUser = isset($_POST['user_id']) ? $_POST['user_id'] : $asset['user_id']; ?>
