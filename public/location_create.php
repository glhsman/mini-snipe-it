...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($data['name'])) {
        ...
        if ($masterData->addLocation($data)) {
            header('Location: locations.php?success=' . urlencode('Standort erfolgreich angelegt.'));
            exit;
        } else {
            $error = "Fehler beim Anlegen des Standorts.";
        }
    }
}
?>
...
<head>
    ...
    <title>Standort anlegen - Mini-Snipe</title>
...
<body>
    <div class="sidebar">
        ...
        <nav>
            ...
            <a href="locations.php" class="nav-link active"><i class="fas fa-map-marker-alt"></i> Standorte</a>
            ...
            <form method="POST">
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="kuerzel" class="form-control" maxlength="2" pattern="[A-Za-z]{2}" placeholder="z.B. MU" value="<?php echo htmlspecialchars($_POST['kuerzel'] ?? ''); ?>" style="text-transform: uppercase;" required>
                    </div>
                    <div class="form-group">
                ...
                <div style="margin-top: 1rem;">
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Standort speichern</button>
